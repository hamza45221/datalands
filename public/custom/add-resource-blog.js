...
var KTModalCustomersAdd = function () {
    ...
    var handleForm = function () {
        ...
        $(document).on("click",'.btn-edit',function(){
            ...
            $('[name="heading1"]').val(data.heading1);
            $('[name="heading2"]').val(data.heading2);
            $('[name="hero_description"]').val(data.hero_description);
            $('[name="download_btn"]').val(data.download_btn);
            $('[name="download_btn_url"]').val(data.download_btn_url);
            $('[name="discover_heaidng"]').val(data.discover_heaidng);
            $('[name="discover_desc"]').val(data.discover_desc);
            $('[name="Key_points_title"]').val(data.Key_points_title);
            $('[name="Key_points"]').val(data.Key_points);
            $('[name="down_event_recap"]').val(data.down_event_recap);
            $('[name="event_recap_title"]').val(data.event_recap_title);
            $('[name="event_recap_list"]').val(data.event_recap_list);
            ...
            $('#event_recap_img').attr('src',data.main_image_1);
        ...
        $('#kt_modal_add_customer').on('hide.bs.modal',function(){
            ...
            $('[name="heading1"]').val('');
            $('[name="heading2"]').val('');
            $('[name="hero_description"]').val('');
            $('[name="download_btn"]').val('');
            $('[name="download_btn_url"]').val('');
            $('[name="discover_heaidng"]').val('');
            $('[name="discover_desc"]').val('');
            $('[name="Key_points_title"]').val('');
            $('[name="Key_points"]').val('');
            $('[name="down_event_recap"]').val('');
            $('[name="event_recap_title"]').val('');
            $('[name="event_recap_list"]').val('');
