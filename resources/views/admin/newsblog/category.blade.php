            ...
            <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
                ...
                <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                    ...
                    <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                        <!--begin::Title-->
                        <h1 class="page-heading d-flex text-gray-900 fw-bold fs-3 flex-column justify-content-center my-0">News Category</h1>
                        <!--end::Title-->
                        <!--begin::Breadcrumb-->
                        <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                            ...
                            <!--end::Item-->
                            <!--begin::Item-->
                            <li class="breadcrumb-item text-muted">News Category</li>
                        ...
                        <div class="card-header border-0 pt-6">
                            ...
                            <div class="card-toolbar">
                                ...
                                <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                                    ...
                                    <!--end::Export-->
                                    <!--begin::Add customer-->
                                    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_add_customer">Add News Category</button>
                                    <!--end::Add customer-->
                                </div>
                                <!--end::Toolbar-->
                                <!--begin::Group actions-->
                    ...
                    <div class="modal fade" id="kt_modal_add_customer" tabindex="-1" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered modal-lg">
                            <div class="modal-content w-100">
                                <form class="form" method="POST" enctype="multipart/form-data" action="{{ route('admin.news.category.store') }}" id="kt_modal_add_customer_form">
                                    @csrf

                                    <!-- Header -->
                                    <div class="modal-header" id="kt_modal_add_customer_header">
                                        <h2 class="fw-bold">Add or Edit News Category</h2>
                                        ...
                                        <div class="scroll-y me-n7 pe-7" id="kt_modal_add_customer_scroll" data-kt-scroll="true"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-12 fv-row mb-3">
                                                    ...
                                                    <textarea name="description" rows="4" id="kt_docs_ckeditor_classic" class="form-control ckeditor"></textarea>
                                                </div>
...
@section('scripts')
    <script>
        var fetchUrl='{{route('admin.news.category.fetch')}}';
    </script>
    ...
    <script src="{{ asset('custom/news-category.js') }}"></script>
    <script src="{{ asset('custom/add-news-category.js') }}"></script>
