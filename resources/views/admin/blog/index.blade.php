                        ...
                        <div class="card-body pt-0">
                            ...
                            <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
                                ...
                                <tr class="text-start text-gray-500 fw-bold fs-7 text-uppercase gs-0">
                                    ...
                                    <th class="min-w-125px">Sub Heading</th>
                    ...
                    <div class="modal fade" id="kt_modal_add_customer" tabindex="-1" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered modal-lg">
                            <div class="modal-content w-100">
                                ...
                                <form class="form" method="POST" enctype="multipart/form-data" action="{{ route('admin.blog.store') }}" id="kt_modal_add_customer_form">
                                    @csrf

                                    <!-- Header -->
                                    <div class="modal-header" id="kt_modal_add_customer_header">
                                        <h2 class="fw-bold">Add or Edit Blog</h2>
                                        ...
                                        <div class="scroll-y me-n7 pe-7" id="kt_modal_add_customer_scroll" data-kt-scroll="true"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-12 mb-3">
                                                    ...
                                                    <textarea name="main_paragraph" rows="3" class="form-control" required></textarea>
                                                </div>
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <input type="text" name="linkedin_icon" class="form-control"
                                                            required>
                                                </div>
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <input type="text" name="facebook_icon" class="form-control"
                                                           value="" required>
                                                </div>
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <input type="text" name="quick_ans_title" class="form-control"
                                                           required>
                                                </div>

                                                <div class="col-md-12 mb-3">
                                                    <label class="form-label">Quick Answer Description</label>
                                                    <textarea name="quick_ans_description" id="kt_docs_ckeditor_classic" rows="3" class="form-control ckeditor"></textarea>
                                                </div>

                                                <!-- Goal -->
                                                <div class="col-md-6 mb-3">
                                                    <label class="form-label">Goal Title</label>
                                                    <input type="text" name="goal_title" class="form-control"
                                                            required>
                                                </div>

                                                <div class="col-md-12 mb-3">
                                                    <label class="form-label">Goal Description</label>
                                                    <textarea name="goal_description" id="kt_docs_ckeditor_classic" rows="3" class="form-control ckeditor"></textarea>
                                                </div>
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <input type="text" name="home_buy_timeline_title" class="form-control"
                                                            required>
                                                </div>

                                                <div class="col-md-12 mb-3">
                                                    <label class="form-label">Timeline Description (Steps 1–2)</label>
                                                    <textarea name="home_buying_timeline_description_step_1_2" rows="4" class="form-control ckeditor"></textarea>
                                                </div>

                                                <div class="col-md-12 mb-3">
                                                    <label class="form-label">Timeline Description (Step 3)</label>
                                                    <textarea name="home_buying_timeline_description_step_3" rows="4" class="form-control ckeditor"></textarea>
                                                </div>

                                                <!-- Bottom Line -->
                                                <div class="col-md-6 mb-3">
                                                    <label class="form-label">Bottom Line Title</label>
                                                    <input type="text" name="bottom_line_title" class="form-control"
                                                            required>
                                                </div>

                                                <div class="col-md-12 mb-3">
                                                    <label class="form-label">Bottom Line Description</label>
                                                    <textarea name="bottom_line_description" rows="4" class="form-control ckeditor"></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
